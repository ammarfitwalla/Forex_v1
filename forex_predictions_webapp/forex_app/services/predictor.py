...
# high_model = load_model(os.getcwd()+os.sep+'forex_app'+os.sep+'ml_models'+os.sep+'high_models'+os.sep+'high.h5')
# low_model = load_model(os.getcwd()+os.sep+'forex_app'+os.sep+'ml_models'+os.sep+'low_models'+os.sep+'low.h5')
...
#     update_actual_values(symbol=symbol,actual_high=last_candle['high'], actual_low=last_candle['low'], actual_open=last_candle['open'], 
#                          actual_close=last_candle['close'], last_time=last_time)
